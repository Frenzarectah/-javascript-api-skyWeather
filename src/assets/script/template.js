    const template=(jsonFile,base)=>{
        ...
        `<nav class="flex flex-row justify-between items-center m-5">
            ...
            <div class="w-full h-screen bg-transparent flex items-center rounded-xl font-anek p-5 flex flex-col text-black">
                <div id="nameCity" class="ut p-5 text-center bg-transparent rounded-md shadow-md shadow-grey text-2xl">404 NOT FOUND</div>
                <div class="flex flex-row justify-center items-center">
                    <div class="m-5" id="meteo_ico text-3xl">¯\\_(ツ)_/¯</div>
